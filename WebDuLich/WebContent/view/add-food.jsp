			...
			<div class="col-md-8">
				...
				<div class="panel panel-default">
					<div class="panel-body">
						<div>
							<form role="form" method="post" action="add-food">
								<%
									if(edit.getPostId() != "")
									{
								...
								<div class="form-group">
									<label for="tour_title">Tên đặc sản:</label> <input
										type="text" class="form-control" required name="txt_place"
										placeholder="Bánh khọt" value="<%out.print(edit.getTitle());%>" id="tour_title">
								</div>
								...
								<div class="form-group">
									<label for="tour_detail">Mô tả đặc sản:</label>
