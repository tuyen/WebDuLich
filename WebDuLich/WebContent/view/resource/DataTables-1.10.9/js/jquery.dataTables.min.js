...
(function (Fa, T, k)
{
	var S = function (h)
	{
			...
			h.each(b, function (e)
			{
				...
				if (d !== k && (c || b[d] === k))
					"o" === d.charAt(0) ? (b[d] || (b[d] = {}
						...
						), h.extend(!0, b[d], b[e]), I(a[d], b[d], c)) : b[d] = b[e]
			}
			)
		}
		function S(a)
		...
		function ub(a)
		{
			...
			for (g = 0; g < c; g++)
				n = b[g], l = f[g], j = "function" == typeof n.mData ? "function" : n.mData, k.columns.push(
				{
					data : j,
					name : n.sName,
		...
		function V(a)
		{
			...
			for (a = 0; a < n.length; a++)
			{
				...
				for (c = f.length; b < c; b++)
					g = f[b], i = e[g].sType || "string", n[a]._idx === k && (n[a]._idx = h.inArray(n[a][1], e[g].asSorting)), d.push(
					{
						src : j,
						col : g,
						dir : n[a][1],
		...
		function Lb(a, b, c)
		{
			...
			e;
			for (e in b)
				b.hasOwnProperty(e) && (d = b[e], h.isPlainObject(d) ? (h.isPlainObject(a[e]) || (a[e] = {}
