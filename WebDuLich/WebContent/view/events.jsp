...
<%
	...
	if (request.getParameter("place") != null) {
		...
		listPost = mdPost.getPosts("4", 10, (cur_page - 1) * 10);
%>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
<title>Lễ hội & sự kiện - Banana Tour</title>
...
<body>
	...
	<div class="container" style="width: 80%">
		...
		<div class="panel panel-body my-panel">
			<lable class="text-left"> <i>Tìm kiếm sự kiện & lễ hội</i></lable>
			<center>
				...
				if (listPost.size() != 0)
					for (dtoPost post : listPost) {
						...
						out.write("<a href='" + request.getContextPath()
								+ "/detail?cate=4&post=" + post.getPostId()
								+ "'> " + post.getTitle() + " </a>");
					...
					out.write("<center> <h3> Không tìm thấy bài viết nào! Bạn hãy là người đầu tiên <a href = '"
							+ request.getContextPath()
							+ "/add-event'> viết bài </a> nhé! </h3> </center>");
			%>
		</ul>
