...
<head>
<meta charset="UTF-8">
<title>Thêm lễ hội & sự kiện - Banana Tour</title>
						...
						<div>
							<form role="form" method="post" action="add-event">
								...
								<div class="form-group">
									<label for="tour_title">Tên sự kiên & lễ hội:</label> <input
										type="text" class="form-control" required name="txt_place"
										placeholder="Lễ hội chọi trâu đồ sơn" value="<%out.print(edit.getTitle());%>" id="tour_title">
								</div>
								...
								<div class="form-group">
									<label for="tour_detail">Mô tả lễ hội:</label>
