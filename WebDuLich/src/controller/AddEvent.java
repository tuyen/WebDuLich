...
public class AddEvent extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		RequestDispatcher rd = request.getRequestDispatcher("view/add-event.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (edit_post == null) {
			this.addAEvent(request, response);
			return;
		} else {
			this.updateAEvent(request, response);
			return;
		}
		// TODO Auto-generated method stub
	...
	private void addAEvent(HttpServletRequest request, HttpServletResponse response) {
		...
		if (btn_post != null && txt_detail != null && txt_location != null) {
			if (txt_detail != "" && txt_location != "") {
				...
				String view_url = "detail?cate=4&post=" + postId;
				try {
	...
	private void updateAEvent(HttpServletRequest request, HttpServletResponse response) {
		String txt_place = request.getParameter("txt_place");
		String txt_detail = request.getParameter("txt_detail");
		String txt_location = request.getParameter("txt_location");
		String btn_post = request.getParameter("btn_post");
		if (btn_post != null && txt_detail != null && txt_location != null) {
			if (txt_detail != "" && txt_location != "") {
				...
				String view_url = "detail?cate=4&post=" + edit_post;
				try {
					response.sendRedirect(view_url);
				} catch (IOException e) {
					// TODO Auto-generated catch block
